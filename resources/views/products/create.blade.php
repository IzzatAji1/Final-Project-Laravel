<x-layout>
    ...
    <form action="{{ route('products.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="number" name="stock" id="stock" class="w-full p-2 border border-gray-300 rounded" value="{{ old('stock') }}">
            @error('stock')
                <p class="text-red-500">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="date" name="expired_at" id="expired_at" class="w-full p-2 border border-gray-300 rounded" value="{{ old('expired_at') }}">
            @error('expired_at')
                <p class="text-red-500">{{ $message }}</p>
            @enderror
        </div>
